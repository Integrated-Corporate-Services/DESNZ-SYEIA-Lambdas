...
export const ENV_KEYS = {
  ...
  GOVPAY_API_KEY: 'GOVPAY_API_KEY',
  GOVPAY_API_URL: 'GOVPAY_API_URL',
  GOVPAY_API_KEY_PARAMETER: 'GOVPAY_API_KEY_PARAMETER',
  EXTERNAL_API_BASE_URL_PARAMETER: 'EXTERNAL_API_BASE_URL_PARAMETER',
